...
public class Oracleapp {
	public static void main(String[] args) throws SQLException, InterruptedException{
		...
		List<Map<String, String>> urlnew = app.crawler("http://www.dianping.com/chengdu/ch75/g3036",2);
      ...
      //      SimpleDateFormat formatter = new SimpleDateFormat("yyyy");
       ...
       //     System.out.println("Date : " + strtodate);
            ...
            insertstr +=addr.substring(4,addr.length()-4) +"','" +  obj.getShopPhone() + "'," + sec.get("commentsnum") +",'" + sec.get("效果") + "','" + sec.get("师资") + "','" + sec.get("环境") + "','" + "1','" + sec.get("stars") + "',8,'法语" + "')";
