...
public class Company {
	...
	private String zhijing;//注册资金
	private String gszch;//工商注册号
	private String zzjgdm;//组织结构代码
	private String tyxydm;//统一信用代码
	private String nsrsbh;//纳税人识别号
	private String yyqx;//营业期限
	private String hzsj;//核准时间
	private String rygm;//人员规模
	private String sjzb;//实缴资本
	...
	public void setNsrzz(String nsrzz) {
		this.nsrzz = nsrzz;
	}
